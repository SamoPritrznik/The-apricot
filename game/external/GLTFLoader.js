...
export class GLTFLoader {
    ...
    async loadNode(nameOrIndex) {
        ...
        if(gltfSpec.name.includes("collision")) node.collision = true;
        if(gltfSpec.name.includes("apricot")) node.apricot = true;
        if(gltfSpec.name.includes("jumpscare")) node.scare = true;
        if(gltfSpec.name.includes("Sphere")) node.sphere = true;
